...
测试结束后，我们会在Matlab中画出这样一张车速随时间变化的图，如图1所示，最后凹下去一大坑，是因为车走到终点被抓住挡着速度降了，拿起来空转速度又飚起来了。

![](/assets/EmbeddedSystem_S5_P0.png)

图1.车速开环阶跃响应测试图

根据这张图我们就可以用1阶或者2阶模型去做建模，在这里选的二阶模型，

![](/assets/EmbeddedSystem_S5_P1.png)

Wn=1.5rad/s，beta=1.6，最终拟合出来的公式就是：

![](/assets/EmbeddedSystem_S5_P2.png)

在matlab中，可以测试一下实测图与模型的对比图
